...
**Reason**: The historical README contract requires development linking, legacy migration, regression procedures, and verification records that are intentionally removed from the user-facing guide.

**Migration**: Replace this documentation contract with "User-facing installation and configuration are documented" below. Preserve public installation, dependencies, and launch keybindings in the new guide; no runtime or user-configuration migration is required.
